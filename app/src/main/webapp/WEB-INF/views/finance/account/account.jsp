                            ...
                            <div class="content-box">
                                ...
                                <div class="account-area">
                                    ...
                                    <div class="account-footer">
                                        <button class="delete-btn" onclick="statusAccount();">상태변경</button>
                                    </div>
                                ...
                                <div class="register-area">
                                    ...
                                    <div class="form-box">
                                        ...
                                        <form>
                                            ...
                                            <div class="form-row">
                                                <label>대분류 계정 과목코드</label>
                                                <input type="text" name="mainAccountNo">
                                            </div>

                                            <div class="form-row">
                                                <label>중분류 계정 과목코드</label>
                                        ...
                                        <div class="register-footer">
                                            <button class="add-btn" onclick="insertAccount();">
                                                추가하기
                                            </button>
                                        </div>
