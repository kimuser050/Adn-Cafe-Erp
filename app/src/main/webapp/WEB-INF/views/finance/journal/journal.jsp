                        ...
                        <div class="page">
                            ...
                            <div class="main-tab-group">
                                <button class="menu-btn active"
                                    onclick="location.href=`/journal/insertJournal`">분개장</button>
                                <button class="menu-btn" onclick="location.href=`/journal/totalList`">총계정원장</button>
                                <button class="menu-btn" onclick="location.href=`/journal/monthList`">월계표</button>
                                <button class="menu-btn" onclick="location.href=`/journal/dailyList`">일계표</button>
                            </div>
