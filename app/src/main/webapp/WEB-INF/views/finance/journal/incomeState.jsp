<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <script defer src="/js/finance/incomeState.js"></script>
    </head>
                    ...
                    <section class="page-content">
                        <div class="page">
                            ...
                            <div class="main-tab-group">
                                <button class="menu-btn" onclick="location.href=`/journal/journalState`">재무상태표</button>
                                <button class="menu-btn active"
                                    onclick="location.href=`/journal/incomeState`">손익계산서</button>
                            </div>
